...
void HKROM_Init(CartInfo *);
void S74LS374NA_Init(CartInfo *);
void SA0161M_Init(CartInfo *);
void SAROM_Init(CartInfo *);
void SBROM_Init(CartInfo *);
void SCROM_Init(CartInfo *);
void SEROM_Init(CartInfo *);
void SGROM_Init(CartInfo *);
void SKROM_Init(CartInfo *);
void SL1ROM_Init(CartInfo *);
void SLROM_Init(CartInfo *);
void SNROM_Init(CartInfo *);
void SOROM_Init(CartInfo *);
void SSSNROM_Init(CartInfo *);
void Super24_Init(CartInfo *);
void TBROM_Init(CartInfo *);
void TEROM_Init(CartInfo *);
void TFROM_Init(CartInfo *);
void TGROM_Init(CartInfo *);
void TKROM_Init(CartInfo *);
void TKSROM_Init(CartInfo *);
void TLROM_Init(CartInfo *);
void TLSROM_Init(CartInfo *);
void TQROM_Init(CartInfo *);
void TQROM_Init(CartInfo *);
void TSROM_Init(CartInfo *);
