...
static DECLFW(M083Write) {
	switch (A &0x31F) {
	case 0x000: bank = V; M083Sync(); break;
	case 0x100: mode = V; M083Sync(); break;
	...
	case 0x300: reg[8] = V; mode &= 0xBF; M083Sync(); break;
	case 0x301: reg[9] = V; mode &= 0xBF; M083Sync(); break;
	case 0x302: reg[10] = V; mode &= 0xBF; M083Sync(); break;
	case 0x310: reg[0] = V; M083Sync(); break;
	case 0x311: reg[1] = V; M083Sync(); break;
	case 0x312: reg[2] = V; M083Sync(); break;
	case 0x313: reg[3] = V; M083Sync(); break;
	case 0x314: reg[4] = V; M083Sync(); break;
	case 0x315: reg[5] = V; M083Sync(); break;
	case 0x316: reg[6] = V; M083Sync(); break;
	case 0x317: reg[7] = V; M083Sync(); break;
	}
}
