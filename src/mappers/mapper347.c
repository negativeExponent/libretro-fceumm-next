...
static DECLFW(M347Write0) {
	reg0 = A & 0xF;
	Sync();
}

static DECLFW(M347Write1) {
	reg1 = A & 0xF;
	Sync();
}
...
static void M347Power(void) {
	...
	SetWriteHandler(0x6000, 0x7FFF, M347RamWrite0);
	SetReadHandler(0x8000, 0xFFFF, CartBR);
	SetWriteHandler(0x8000, 0x8FFF, M347Write0);
	SetWriteHandler(0x9000, 0x9FFF, M347Write1);
	SetReadHandler(0xB800, 0xD7FF, M347RamRead1);
	SetWriteHandler(0xB800, 0xD7FF, M347RamWrite1);
}
