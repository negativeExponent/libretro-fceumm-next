...
static void M124Power(void) {
	...
	SetReadHandler(0x0000, 0x0FFF, ReadRAM);
	SetWriteHandler(0x0000, 0x0FFF, WriteRAM);
...
void Mapper124_Init(CartInfo *info) {
	...
	mRAM = (uint8 *)FCEU_gmalloc(4096);
	AddExState(mRAM, 4096, 0, "mRAM");
