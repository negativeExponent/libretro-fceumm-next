...
int FCEU_VSUniGetPaletteNum(void) {
	...
	case PPU_RC2C05_03:
	case PPU_RC2C05_04:
	case PPU_RC2C05_05:   return PAL_RP2C03;
	case PPU_RP2C04_0001: return PAL_RP2C04_0001;
	case PPU_RP2C04_0002: return PAL_RP2C04_0002;
	case PPU_RP2C04_0003: return PAL_RP2C04_0003;
	case PPU_RP2C04_0004: return PAL_RP2C04_0004;
	}
}
...
void FCEU_VSUniCheck(uint64 md5partial, int *MapperNo, int *Mirroring) {
	...
	if (GameInfo->type == GIT_VSUNI) {
		FCEU_printf(" [VS] Name:     %s\n", name);
		switch (vsuni_system.ppu) {
		default:
		case PPU_RC2C03:      FCEU_printf(" [VS] Ppu:      2C03x\n"); break;
		case PPU_RC2C05_01:   FCEU_printf(" [VS] Ppu:      2C05-01\n"); break;
		case PPU_RC2C05_02:   FCEU_printf(" [VS] Ppu:      2C05-02\n"); break;
		case PPU_RC2C05_03:   FCEU_printf(" [VS] Ppu:      2C05-03\n"); break;
		case PPU_RC2C05_04:   FCEU_printf(" [VS] Ppu:      2C05-04\n"); break;
		case PPU_RC2C05_05:   FCEU_printf(" [VS] Ppu:      2C05-05\n"); break;
		case PPU_RP2C04_0001: FCEU_printf(" [VS] Ppu:      2C04-0001\n"); break;
		case PPU_RP2C04_0002: FCEU_printf(" [VS] Ppu:      2C04-0002\n"); break;
		case PPU_RP2C04_0003: FCEU_printf(" [VS] Ppu:      2C04-0003\n"); break;
		case PPU_RP2C04_0004: FCEU_printf(" [VS] Ppu:      2C04-0004\n"); break;
		}
		switch (vsuni_system.type) {
		default:
		case VS_TYPE_NORMAL:     FCEU_printf(" [VS] Type:     VS-UniSystem (Normal)\n"); break;
		case VS_TYPE_RBI:        FCEU_printf(" [VS] Ppu:      VS-UniSystem (RBI Baseball)\n"); break;
		case VS_TYPE_TKO:        FCEU_printf(" [VS] Ppu:      VS-UniSystem (TKO Boxing)\n"); break;
		case VS_TYPE_XEVIOUS:    FCEU_printf(" [VS] Ppu:      VS-UniSystem (Super Xevious)\n"); break;
		case VS_TYPE_ICECLIMBER: FCEU_printf(" [VS] Ppu:      VS-UniSystem (Ice Climber)\n"); break;
		case VS_TYPE_DUAL:       FCEU_printf(" [VS] Ppu:      VS-DualSystem (Normal)\n"); break;
		case VS_TYPE_RAID:        FCEU_printf(" [VS] Ppu:      VS-DualSystem (Raid on Bungeling Bay protection)\n"); break;
		}
	}
}
