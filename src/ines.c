...
/*    INES_BOARD( "",                         39, Mapper39_Init ) */
	...
	INES_BOARD( "MMC3 BMC PIRATE C/820401/T-217", 49, Mapper049_Init         )
...
/*    INES_BOARD( "",                         54, Mapper54_Init ) */
	...
	INES_BOARD( "Irem-H-3001",               65, Mapper065_Init         )
	INES_BOARD( "GNROM / MHROM",             66, Mapper066_Init         )
	INES_BOARD( "SUNSOFT-3",                 67, Mapper067_Init         )
	INES_BOARD( "SUNSOFT-4",                 68, Mapper068_Init         )
	INES_BOARD( "SUNSOFT 5A/5B",             69, Mapper069_Init         )
...
/*    INES_BOARD( "",                            135, Mapper135_Init ) */ /* Duplicate of 135 */
	...
	INES_BOARD( "BANDAI DATACH/BARCODE",    157, Mapper157_Init         )
...
/*    INES_BOARD( "",                            251, Mapper251_Init ) */ /* No good dumps for this mapper, use UNIF version */
	...
	INES_BOARD( "YOKO",                     264, Mapper083_Init         )
	...
	INES_BOARD( "FK-206 JG",                472, Mapper472_Init         )
	...
	INES_BOARD( "KN-20",                    577, Mapper577_Init         )
	...
	INES_BOARD( "",                         474, Mapper474_Init         )
	INES_BOARD( "",                         475, Mapper475_Init         )
	INES_BOARD( "Croaky Karaoke",           476, Mapper476_Init         )
	INES_BOARD( "15-in-1",                  477, Mapper477_Init         )
	INES_BOARD( "",                         480, Mapper480_Init         )
	INES_BOARD( "K-1079",                   482, Mapper482_Init         )
	INES_BOARD( "PCB3927",                  483, Mapper483_Init         )
