...
static struct CHINF nesdb[] = {
	...
	/* { 0x511e73f8,   27, DEFAULT, DEFAULT, 0, DEFAULT, DEFAULT, DEFAULT, NOEXTRA }, */ /* moved to mapper 006 */ /* Mi Hun Che (Ch) [p1][b2].nes */
	...
	/* { 0xe84274c5,   66, DEFAULT,    MI_V, 0, DEFAULT, DEFAULT, DEFAULT, NOEXTRA }, */ /*moved to mapper 8/mapper 6.sub4 */ /* Mississippi Satsujin Jiken (J) [h2].nes */
...
/*	{ 0x071e4ee8,  114, DEFAULT, DEFAULT, 0, DEFAULT, DEFAULT, DEFAULT, NOEXTRA }, */ /* ?? m114,submapper 1 test rom */
	...
	{ 0x05658ded,  201,      15,    MI_H, 0, DEFAULT, DEFAULT, DEFAULT, NOEXTRA }, /* 21-in-1 (CF-043) (2006-V) (Unl) [p1].nes */
	...
	{ 0xf956fcea,  521, DEFAULT, DEFAULT, 0, DEFAULT,    0x07, DEFAULT, NOEXTRA }, /* Korean Igo (Korea) (Unl).nes */
	...
	{ 0x2BB6FDBD,  336,       2, DEFAULT, 0, DEFAULT, DEFAULT, DEFAULT, NOEXTRA }, /* 2-in-1 (YH218) (Unl) */
	...
	{ 0x4AE9EE7D,  242, DEFAULT, DEFAULT, 0, DEFAULT, DEFAULT, DEFAULT, NOEXTRA }, /* (Realtec CK-001, CK-002) 4-in-1 1993, 20-in-1 9 */
